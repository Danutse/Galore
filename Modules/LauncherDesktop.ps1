...
$GaloreModuleManifest = [ordered]@{
    ...
    RequiresFiles = @(
        "Resources\close.png", "Resources\downloads.png", "Resources\games.png",
        "Resources\images.png", "Resources\maximize.png", "Resources\minimize.png",
        "Resources\misc.png", "Resources\notes.png", "Resources\programs.png",
        "Resources\recyclebin.png", "Resources\thispc.png"
    )
    ProvidesTypes = @()
}
...
$thisPCButton.Location =
New-Object System.Drawing.Point(
    0,
    0
)

$thisPCButton.FlatStyle =
[System.Windows.Forms.FlatStyle]::Flat

$thisPCButton.FlatAppearance.BorderSize = 0

$thisPCButton.BackColor =
[System.Drawing.Color]::Transparent

$thisPCButton.FlatAppearance.MouseOverBackColor =
...
$thisPCButton.FlatAppearance.MouseDownBackColor =
[System.Drawing.Color]::FromArgb(
    100,
    255,
    255,
...
$recycleBinButton.Width =
40

$recycleBinButton.Height =
40

$recycleBinButton.Location =
New-Object System.Drawing.Point(
    40,
    0
)

$recycleBinButton.FlatStyle =
[System.Windows.Forms.FlatStyle]::Flat

$recycleBinButton.FlatAppearance.BorderSize =
0

$recycleBinButton.BackColor =
[System.Drawing.Color]::Transparent

$recycleBinButton.FlatAppearance.MouseOverBackColor =
[System.Drawing.Color]::FromArgb(
    20,
    255,
    255,
...
$recycleBinButton.FlatAppearance.MouseDownBackColor =
[System.Drawing.Color]::FromArgb(
    100,
    255,
    255,
...
$recycleBinButton.Add_DragDrop({
    ...
    try
    {
        ...
        )
        {
            ...
            catch
            {
                ...
                -Exception $_ `
                -Context "Failed to recycle dropped item '$file'."
    ...
    catch
    {
        ...
        Write-LauncherDiagnostic `
        -Exception $_ `
        -Context "Recycle-bin drop handling failed."
...
-Icon "games.png" `
-Folder $GamesFolder `
-Tooltip "Game Shortcut"

$script:ProgramsFolder =
Resolve-GaloreTaskbarFolder `
"ProgramShortcut"
...
function Show-DesktopShortcutDialog {
    ...
    $programsButton.Width =
    170

    $programsButton.Height =
    35
...
function New-StartupToggle {
    ...
    $startupToggle.ForeColor =
    [System.Drawing.Color]::White

    $startupToggle.BackColor =
    [System.Drawing.Color]::Transparent
...
function Initialize-DesktopButtons {
    ...
    param(
        ...
        [System.Windows.Forms.Control]$TitleBar
    )
    ...
    [GaloreDropHelper.Exports]::AttachRecycleDrop(
        $recycleBinButton.Handle
    )
